...
- 印が付いた文書のうち、実装が届いたものを挙げる
- 起動できるコマンドと機能の集合の差を挙げる
...
- 図のラベルがパスやコマンド名の形をしているなら、その実在を確かめる
...
- 存在しないコマンド名をラベルに持つ図を置き、それが挙がることを見る
