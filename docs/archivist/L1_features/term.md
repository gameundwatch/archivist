...
<!-- 条項が意味を確定させた語を、L3_terms に1ファイルとして書く -->

## Background

条項は語を使う。その語の意味が条項によって初めて定まるとき、意味はどこにも
書かれないまま上層へ運ばれる。読み手ごとに違う意味で読まれる余地が残る。

## Availability

- **A1** 条項を指定して起動すると、その条項が意味を確定させた語が1枚起きる

- **A2** 既に語がある場合、条項と食い違う定義が書き直される

- **A3** 語は1ファイル1語で、ファイル名が語そのものになる

- **A4** 起きた語は、自分を確定させた条項を持つ
